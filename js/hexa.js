      ...
      `<div class="single-post" data-post_id=${post.id}>
                                                                ...
                                                                <div class="post-comments">
                                                                    <form>
                                                                        ...
                                                                        <button onclick="commentPostSumbit(event)">Comment</button>
                                                                    </form>
                                                                </div>
                                                            </div> ` + html;
  }
    ...
    async function getPostUser() {
      ...
      if (comments.length > 0) {
        for (const comment of comments) {
          let user_comment = new User();
          user_comment = await user_comment.get(comment.user_id);
          comments_html += `<div class="single-comment"><p><b>Author:</b> ${user_comment.username}</p>${comment.content}</div>`;
        }
      }
